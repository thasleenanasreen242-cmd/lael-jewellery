        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <button className="rounded-full bg-[#1D1A17] px-6 py-3 text-[0.68rem] uppercase tracking-[0.24em] text-[#FFFDF8]">Add to Bag</button>
              <button className="rounded-full border border-[#29251F]/15 bg-[#FFFDF8] px-6 py-3 text-[0.68rem] uppercase tracking-[0.24em] text-[#29251F]">Buy Now</button>
              <a href={buildWhatsAppLink(addToCartMessage)} target="_blank" rel="noreferrer" className="rounded-full border border-[#1D1A17]/15 bg-[#EFE5D6] px-6 py-3 text-[0.68rem] uppercase tracking-[0.24em] text-[#29251F]">Ask on WhatsApp</a>
            </div>
